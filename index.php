...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            ...
            <li><span>Image 02</span><div><h3>NEVER FROZEN</h3></div></li>
            <li><span>Image 03</span><div><h3>ALWAYS FRESH</h3></div></li>
            <li><span>Image 04</span><div><h3>NEVER FROZEN</h3></div></li>
            <li><span>Image 05</span><div><h3>ALWAYS FRESH</h3></div></li>
            <li><span>Image 06</span><div><h3>NEVER FROZEN</h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>GROUPER<br> & CHIPS</span></h1>
